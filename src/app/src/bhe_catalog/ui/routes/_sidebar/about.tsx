...
const GOLD_TABLES: TableSpec[] = [
  ...
  },
  {
    name: "affiliates",
    purpose:
      "BHE operating companies: PacifiCorp, MidAmerican Energy, NV Energy, BHE Pipelines, BHE Renewables, BHE Transmission, AltaLink, Northern Powergrid, etc. Seeded from src/data/affiliates_seed.csv.",
    columns: [
      "affiliate_name",
      "affiliate_code",
      "business_type",
    ...
    writtenBy: ["build_value_model.py (seed_affiliates stage)"],
...
const JOBS: JobSpec[] = [
  ...
  },
  {
    ...
    stages: [
      "seed_affiliates - upsert from affiliates_seed.csv",
